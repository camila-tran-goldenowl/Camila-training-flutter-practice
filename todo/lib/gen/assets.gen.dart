...
class $AssetsSvgsGen {
  ...
  /// File path: assets/svgs/avatar.svg
  String get avatar => 'assets/svgs/avatar.svg';

  /// File path: assets/svgs/bg.svg
  String get bg => 'assets/svgs/bg.svg';
  ...
  /// File path: assets/svgs/pattern.svg
  String get pattern => 'assets/svgs/pattern.svg';
  ...
  String get trash => 'assets/svgs/trash.svg';
...
class $AssetsImagesImagesGen {
  ...
  /// File path: assets/images/images/bg.png
  AssetGenImage get bg => const AssetGenImage('assets/images/images/bg.png');
