...
import 'package:myapp/src/features/tasks/view/create_new_task.dart';
    ...
    routes: <RouteBase>[
      ...
      ShellRoute(
        ...
        routes: <RouteBase>[
          ...
          GoRoute(
            path: AppRouteNames.createNewTask.path,
            name: AppRouteNames.createNewTask.name,
            builder: (_, __) => const CreateNewTaskView(),
          ),
        ],
      ),
      GoRoute(
